                ...
                'details'      => '
{
    ...
    "options": {
        ...
        $dataRow = $this->dataRow($postDataType, 'register_date');
        if (!$dataRow->exists) {
            $dataRow->fill([
                'type'         => 'timestamp',
                'display_name' => 'register_date',
                'required'     => 0,
                'browse'       => 1,
                'read'         => 1,
                'edit'         => 0,
        ...
        $dataRow = $this->dataRow($postDataType, 'update_date');
        if (!$dataRow->exists) {
            $dataRow->fill([
                'type'         => 'timestamp',
                'display_name' => 'update_date',
                'required'     => 0,
                'browse'       => 0,
                'read'         => 0,
                'edit'         => 0,
        ...
        $dataRow = $this->dataRow($pageDataType, 'register_date');
        if (!$dataRow->exists) {
            $dataRow->fill([
                'type'         => 'timestamp',
                'display_name' => 'register_date',
        ...
        $dataRow = $this->dataRow($pageDataType, 'update_date');
        if (!$dataRow->exists) {
            $dataRow->fill([
                'type'         => 'timestamp',
                'display_name' => 'update_date',
        ...
        $dataRow = $this->dataRow($userDataType, 'register_date');
        if (!$dataRow->exists) {
            $dataRow->fill([
                'type'         => 'timestamp',
                'display_name' => 'register_date',
        ...
        $dataRow = $this->dataRow($userDataType, 'update_date');
        if (!$dataRow->exists) {
            $dataRow->fill([
                'type'         => 'timestamp',
                'display_name' => 'update_date',
        ...
        $dataRow = $this->dataRow($menuDataType, 'register_date');
        if (!$dataRow->exists) {
            $dataRow->fill([
                'type'         => 'timestamp',
                'display_name' => 'register_date',
        ...
        $dataRow = $this->dataRow($menuDataType, 'update_date');
        if (!$dataRow->exists) {
            $dataRow->fill([
                'type'         => 'timestamp',
                'display_name' => 'update_date',
        ...
        $dataRow = $this->dataRow($categoryDataType, 'register_date');
        if (!$dataRow->exists) {
            $dataRow->fill([
                'type'         => 'timestamp',
                'display_name' => 'register_date',
        ...
        $dataRow = $this->dataRow($categoryDataType, 'update_date');
        if (!$dataRow->exists) {
            $dataRow->fill([
                'type'         => 'timestamp',
                'display_name' => 'update_date',
        ...
        $dataRow = $this->dataRow($roleDataType, 'register_date');
        if (!$dataRow->exists) {
            $dataRow->fill([
                'type'         => 'timestamp',
                'display_name' => 'register_date',
        ...
        $dataRow = $this->dataRow($roleDataType, 'update_date');
        if (!$dataRow->exists) {
            $dataRow->fill([
                'type'         => 'timestamp',
                'display_name' => 'update_date',
