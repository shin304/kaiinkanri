                ...
                <table class="table table-striped database-tables">
                    <thead>
                        <tr>
                            ...
                            <th style="text-align:right">テーブル Actions</th>
                        </tr>
                    </thead>
                            ...
                            @else
                                <a href="{{ route('voyager.database.create_bread', ['name' => $table->name]) }}"
                                   class="btn-sm btn-default">
                                    <i class="voyager-plus"></i> BREAD追加
                                </a>
                            @endif
                            </div>
                        </td>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title"><i class="voyager-trash"></i> <span id="delete_builder_name"></span>を削除しますか。</h4>
                </div>
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-outline pull-right" data-dismiss="modal">キャンセル</button>
                </div>
            </div><!-- /.modal-content -->
        </div><!-- /.modal-dialog -->
    </div><!-- /.modal -->
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span
                                aria-hidden="true">&times;</span></button>
                    <h4 class="modal-title"><i class="voyager-trash"></i>  <span
                                id="delete_table_name"></span>を削除しますか。</h4>
                </div>
                <div class="modal-footer">
    ...
    <div class="modal modal-info fade" tabindex="-1" id="table_info" role="dialog">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-outline pull-right" data-dismiss="modal">閉じる</button>
                </div>
            </div><!-- /.modal-content -->
        </div><!-- /.modal-dialog -->
    </div><!-- /.modal -->
        ...
        $(function () {
            ...
            $('td.actions').on('click', '.delete_table', function (e) {
                ...
                if ($(this).hasClass('remove-bread-warning')) {
                    toastr.warning("テーブルを削除する前にBREADを削除してください。");
                } else {
