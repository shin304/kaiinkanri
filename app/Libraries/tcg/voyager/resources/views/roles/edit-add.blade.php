...
@section('page_header')
    <h1 class="page-title">
        <i class="{{ $dataType->icon }}"></i> @if(isset($dataTypeContent->id)){{ '権限編集' }}@else{{ '新規権限' }}@endif 
    </h1>
@stop
            ...
            <div class="col-md-12">
                ...
                <div class="panel panel-bordered">
                    ...
                    <div class="panel-heading">
                        <h3 class="panel-title">@if(isset($dataTypeContent->id)){{ '編集情報' }}@else{{ '新規追加' }}@endif </h3>
                    </div>
                    <!-- /.box-header -->
                    <!-- form start -->
                    <form role="form"
                        ...
                        <div class="panel-body">
                            ...
                            <label for="permission">権限</label><br>
                            <a href="#" class="permission-select-all">全て選択</a> / <a href="#"  class="permission-deselect-all">すべての選択を解除</a>
