                ...
                <div class="panel panel-bordered">
                    ...
                    <form role="form"
                        ...
                        <div class="panel-body">
                                ...
                                @if($row->field == "plan_amount")
                                        <div class="form-group @if($row->type == 'hidden') hidden @endif">
                                            ...
                                            <input type="text" class="form-control" name="{{ $row->field }}"
                                                   ...
                                                   value="@if(isset($dataTypeContent->{$row->field})){{old($row->field, number_format($dataTypeContent->{$row->field})) }}@else{{ old($row->field)}}@endif">
                                        </div>
                                @else
                                    <div class="form-group @if($row->type == 'hidden') hidden @endif">
                                        <label for="name">{{ $row->display_name }}</label>
                            ...
                            {{--Menu selection--}}
                            @include('voyager::partials.menu_selection')
                            {{--end menu--}}
