...
@section('page_header')
    <h1 class="page-title">
        <i class="voyager-list"></i>メニュー作成 ({{ $menu->name }})
        <div class="btn btn-success add_item"><i class="voyager-plus"></i>メニュー追加</div>
    </h1>
            ...
            <div class="col-md-12">
                ...
                <div class="panel panel-bordered">
                    ...
                    <div class="panel-heading">
                        <p class="panel-title" style="color:#777">ドラッグアンドドロップでメニューの並び順が替えることができます。</p>
                    </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title"><i class="voyager-trash"></i> このメニューを削除しますか。</h4>
                </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span
                                aria-hidden="true">&times;</span></button>
                    <h4 class="modal-title"><i class="voyager-plus"></i>新メニューを追加する</h4>
                </div>
                <form action="{{ route('voyager.menus.item.add', ['menu' => $menu->id]) }}" id="add_form" method="POST">
                    <div class="modal-body">
                        ...
                        <input type="text" class="form-control" name="icon_class"
                               placeholder="アイコンプラン (optional)"><br>
                    ...
                    <div class="modal-footer">
                        <input type="submit" class="btn btn-success pull-right delete-confirm" value="追加">
                        <button type="button" class="btn btn-default pull-right" data-dismiss="modal">キャンセル</button>
                    </div>
                </form>
            </div><!-- /.modal-content -->
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span
                                aria-hidden="true">&times;</span></button>
                    <h4 class="modal-title"><i class="voyager-edit"></i>編集</h4>
                </div>
                <form action="{{ route('voyager.menus.item.update', ['menu' => $menu->id]) }}" id="edit_form" method="POST">
                    ...
                    <div class="modal-body">
                        ...
                        <input type="text" class="form-control" id="edit_title" name="title" placeholder="メニュー名"><br>
                        <label for="type">リンク種類</label>
                    ...
                    <div class="modal-footer">
                        <input type="submit" class="btn btn-success pull-right delete-confirm" value="編集">
                        <button type="button" class="btn btn-default pull-right" data-dismiss="modal">キャンセル</button>
                    </div>
                </form>
            </div><!-- /.modal-content -->
