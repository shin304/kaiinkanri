...
Route::group(['as' => 'voyager.'], function () {
    ...
    Route::group(['middleware' => 'admin.user'], function () use ($namespacePrefix) {
        ...
        Route::post('temp-school-info/lock/{id}', ['uses' => 'Admin\TempSchoolInfoController@lock', 'as' => 'temp-school-info.lock']);
        Route::post('temp-school-info/approve', ['uses' => 'Admin\TempSchoolInfoController@approve', 'as' => 'temp-school-info.approve']);
        try {
