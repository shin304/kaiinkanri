                    ...
                    <div class="panel-body table-responsive">
                        <table id="dataTable" class="row table table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    @php $is_edit = 1; @endphp
                                    @foreach($dataType->browseRows as $row)
                                    @php 
                                        if($row->field == 'message_file_name' && $data->{$row->field} =='common') {
                                            $is_edit = 0;
                                        }
                                    @endphp
                                        <td>
                                    ...
                                    <td class="no-sort no-click" id="bread-actions">
                                        @if (Voyager::can('delete_'.$dataType->name) && $is_edit==1)
                                        ...
                                        @endif
                                        @if (Voyager::can('edit_'.$dataType->name) && $is_edit==1)
