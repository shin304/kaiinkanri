...
<script type="text/javascript">
    $(function(){
        $('.submit').click(function (e) {
            e.preventDefault();
            var msg = "イベント「{{$data['course_title']}}」に" + $(this).data("mess") + "<br>よろしいですか。";
    ...
    <div class="content_detail">
        ...
        <form id="action_form" action="{{$_app_path}}event/confirm" method="POST" enctype="multipart/form-data" novalidate>
            {{ csrf_field() }}
